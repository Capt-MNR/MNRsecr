...
- [Mobile companion boundary](mobile-two-surface-architecture.md) — the web app is the full workspace; mobile stays a lightweight quick assistant for requests, notifications, and approvals.
